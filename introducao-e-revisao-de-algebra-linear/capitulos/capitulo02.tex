...
\begin{document}
	...
	\section{Matrizes}
		As matrizes permitem uma manipulação facilitada dos sistemas lineares e uma abstração maior, porque, fundamentalmente, elas são tabelas de números ou variáveis, que se assemelham com o formato de sistemas lineares. Além disso, também podem ser interpretadas como vetores ou até mesmo objetos de estudo da Álgebra Linear, como as Transformações Lineares, entrelaçando todos os elementos de interesse dessa área.
		\begin{definicao}
		...
		\begin{definicao}
			...
			\end{itemize}
		\end{definicao}
		A seguir definiremos as operações com matrizes.
		\begin{definicao}
