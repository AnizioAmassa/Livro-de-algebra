...
\begin{document}
	...
	\section{Matrizes}
		...
		Com todas as operações apresentadas, podemos apresentar as demais propriedades de matrizes.
		...
		\subsection{Matriz Inversa}
			Outro conceito fundamental para matrizes é de invertibilidade. Isso se dá pela relativa dificuldade de determinar a inversa das matrizes, mas também pelas propriedades que são adquiridas com as matrizes inversas.
			\begin{definicao}
		...
		\subsection{Determinante}
			...
			\begin{definicao}
				...
				\begin{itemize}
					...
					\item $\tilde{A}_{ij}$, dado pela submatriz de $A$ de ordem $(n-1)\times (n-1)$ eliminando a $i$-ésima linha e a $j$-ésima coluna, é a \azul{matriz menor} do elemento $a_{ij}$.
				\end{itemize} 
			\end{definicao}
