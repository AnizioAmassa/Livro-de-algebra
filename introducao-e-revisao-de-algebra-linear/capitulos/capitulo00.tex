...
\begin{document}
	...
	\newpage
	A minha colaboração neste material foi motivada, majoritariamente, pelas dificuldades pessoais que enfrentei ao cursar Álgebra Linear. Maior parte do que abordei aqui foi no capítulos 3 (Espaços vetoriais, bases, etc...). Busquei um viés que facilite o acompanhamento do curso, servindo tanto para o aprendizado inicial quanto para revisão. Os exercícios aqui presentes foram selecionados de listas anteriores e de referências clássicas da bibliografia.
	...
	Esse texto pretende virar um livro em algum momento, você pode acessar como ele está no \href{https://sites.google.com/view/anizio}{meu site} (clicável).
