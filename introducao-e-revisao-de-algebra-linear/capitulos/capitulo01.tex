...
\begin{document}
	...
	\section{Geometria Analítica}
		...
		\subsection*{Equações da reta e do plano}
			...
			As equações apresentadas essas definições são o que chamamos de \azul{equações vetoriais} desses objetos geométricos. Além delas, existem outras formas de representar retas e planos: as equações paramétricas e as equações  gerais. As retas, em especial, possuem outras duas formas particulares, que são a reduzida (muito conhecida no Ensino Médio no formato de função) e a simétrica.
			...
			\[
			\begin{cases}
				r=\{P\in \mathbb{R}^3\, \mid\, 	P=(\textcolor{red}{x_0+tv_1},\,\textcolor{green!60!black}{y_0+tv_2},\, \textcolor{orange}{z_0+tv_3})\}\\
				\pi = \{P\in \mathbb{R}^3\, \mid \, 	P=(\textcolor{red}{x_0+tv_1+sw_1}, \, \textcolor{green!60!black}{y_0+tv_2+sw_2}, \, \textcolor{orange}{z_0+tv_3+sw_3})\}
			\end{cases}
			\]
			...
			\begin{proposicao}
				A \azul{equação geral de uma reta} $r$ no $\mathbb{R}^2$ que passa por um ponto 
				$P_0 = (x_0, y_0)$ é
				\[
				ax + by + c = 0,
				\]
			...
			Note que essa definição, para o $\mathbb{R}^3$, na verdade descreve um plano! Para o espaço, a descrição é um pouco diferente.
			...
			Assim, note que, fixado um ponto $P_0=(x_0,y_0,z_0)$ e um vetor normal ao plano $N=(a,b,c)$, temos que o plano pode ser definido como $\pi=\{P\in \mathbb{R}^3\, \mid\, N\perp \vv{PP_0}\}$, ou seja, como o conjunto de pontos cujo vetor com o ponto fixo $P_0$ é sempre perpendicular ao normal. Lembre, no entanto, que
			\begin{align*}
				N\perp \vv{PP_0}
